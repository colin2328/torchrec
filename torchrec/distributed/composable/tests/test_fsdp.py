...
class FSDPTestComposable(unittest.TestCase):
    ...
    def _run(cls) -> None:
        ...
        # TODO once global_registry is added to contract, remove ignored_modules
        # TODO add auto_wrap_policy
        m = fully_shard(m, device_id=device.index, ignored_modules=m.sparse.modules())
